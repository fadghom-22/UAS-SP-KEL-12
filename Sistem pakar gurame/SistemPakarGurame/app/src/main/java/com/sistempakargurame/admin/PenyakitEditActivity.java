package com.sistempakargurame.admin;
...
import com.sistempakargurame.MySingleton;
import com.sistempakargurame.R;
...
public class PenyakitEditActivity extends AppCompatActivity {
    ...
    private static final String url = "http://192.168.1.8/spgurame/sp_gurame/get_penyakit.php";
    private static final String url_update = "http://192.168.1.8/spgurame/sp_gurame/update_penyakit.php";
    private static final String url_delete = "http://192.168.1.8/spgurame/sp_gurame/delete_penyakit.php";
