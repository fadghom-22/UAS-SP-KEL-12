...
public class AturanEditActivity extends AppCompatActivity {
    ...
    private static final String url = "http://192.168.1.8/spgurame/sp_gurame/get_daftar_gejala.php";
    private static final String url_update = "http://192.168.1.8/spgurame/sp_gurame/update_aturan.php";
